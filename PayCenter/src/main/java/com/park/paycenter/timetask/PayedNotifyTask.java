...
public class PayedNotifyTask  implements TaskPlanService{
	...
	public void executeInternal(){
		...
		List<FailNotifyRecord> records = failNotifyRecordDao.findByStatus(NotifyStatusConstants.RED, DateTools.addTime(new Date(), 0));
	...
	public boolean payed_notify(FailNotifyRecord record){
		...
		try {
			String result = HttpJsonTools.HttpClientGet(notify_url, params,new HashMap<String,String>());
			/**通知返回成功*/
