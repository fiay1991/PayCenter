package com.park.paycenter.alipay.trade.service.impl;
...
import com.park.paycenter.alipay.trade.config.Constants;
import com.park.paycenter.alipay.trade.model.TradeStatus;
...
public class AlipayTradeServiceImpl extends AbsAlipayTradeService {
    ...
    public AlipayF2FPayResult tradePay(AlipayTradePayContentBuilder builder) {
        ...
        //request.setNotifyUrl("http://alphapaycenter.51park.cn/PayCenter/AlipayController/notice_of_payment");
        request.setNotifyUrl(alipayProfile.getNotify_url());
        log.info("trade.pay bizContent:" + request.getBizContent());
        System.out.println("alipayProfile.getNotify_url:"+alipayProfile.getNotify_url());
        System.out.println("request.getReturnUrl:"+request.getReturnUrl());
        // 首先调用支付api
